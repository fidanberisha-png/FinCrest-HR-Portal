...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Index the portal accounts by full name and by the e-mail local part, so a
    // roster line still matches an account when one of the two differs.
    const accounts = {};
    ...
    // Anyone with an account who is not on the roster is listed after it.
    people.forEach(function (person) {
